...
type GenerateURLRequest struct {
	// url — reference where will the json get from
...
func (m *GenerateURLRequest) GetUrl() string {
	if m != nil {
		return m.Url
	}
	return ""
...
type IssuerConnection struct {
	...
	Descredits           *DiscreditList `protobuf:"bytes,2,opt,name=descredits,proto3" json:"descredits,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
	XXX_unrecognized     []byte         `json:"-"`
	XXX_sizecache        int32          `json:"-"`
}
...
func (m *IssuerConnection) GetDescredits() *DiscreditList {
	if m != nil {
		return m.Descredits
	}
	return nil
...
var fileDescriptor_f2f15fabe54a973d = []byte{
	...
	,
}
